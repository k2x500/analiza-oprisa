...
## 3.3 Planul de Reducere a Flotei (Șoferi Unici de Concediat/Redus pe Orașe)

Tabelul de mai jos indică numărul **exact de șoferi unici** care trebuie eliminați din flotă (concediați sau cărora li se va suspenda activitatea auto) pentru fiecare oraș, defalcat pe tipurile de contract neprofitabile (Minijob și Teilzeit/TZ).

| Oraș | Minijob (Bicicletă) | Minijob (Mașină) | Teilzeit / TZ (Bicicletă) | Teilzeit / TZ (Mașină) | Total Șoferi de Redus |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Aachen** | 1 | 0 | 0 | 1 | **2** |
| **Aschaffenburg** | 0 | 0 | 1 | 4 | **5** |
| **Augsburg** | 6 | 12 | 5 | 40 | **63** |
| **Berlin** | 30 | 19 | 44 | 68 | **161** |
| **Bielefeld** | 5 | 3 | 7 | 13 | **28** |
| **Bochum** | 0 | 0 | 1 | 10 | **11** |
| **Bonn** | 0 | 2 | 1 | 0 | **3** |
| **Cologne** | 0 | 2 | 0 | 4 | **6** |
| **Dortmund** | 0 | 0 | 1 | 5 | **6** |
| **Duisburg** | 0 | 0 | 2 | 3 | **5** |
| **Dusseldorf** | 0 | 2 | 3 | 15 | **20** |
| **Erlangen** | 1 | 1 | 2 | 1 | **5** |
| **Essen** | 0 | 1 | 0 | 10 | **11** |
| **Frankfurt am Main** | 5 | 21 | 10 | 82 | **118** |
| **Freiburg im Breisgau** | 3 | 4 | 2 | 6 | **15** |
| **Fuerth** | 4 | 9 | 0 | 11 | **24** |
| **Gelsenkirchen** | 0 | 1 | 4 | 7 | **12** |
| **Guetersloh** | 1 | 1 | 0 | 0 | **2** |
| **Hagen** | 0 | 2 | 1 | 5 | **8** |
| **Hamburg** | 3 | 3 | 4 | 16 | **26** |
| **Hamm** | 0 | 0 | 2 | 1 | **3** |
| **Hanau** | 2 | 8 | 3 | 9 | **22** |
| **Hannover** | 0 | 2 | 1 | 2 | **5** |
| **Harburg** | 1 | 1 | 2 | 1 | **5** |
| **Heidelberg** | 1 | 4 | 5 | 11 | **21** |
| **Heilbronn** | 0 | 5 | 0 | 6 | **11** |
| **Herne** | 0 | 0 | 1 | 2 | **3** |
| **Ingolstadt** | 1 | 3 | 0 | 8 | **12** |
| **Iserlohn** | 0 | 0 | 0 | 1 | **1** |
| **Karlsruhe** | 6 | 6 | 2 | 11 | **25** |
| **Kassel** | 0 | 1 | 0 | 0 | **1** |
| **Krefeld** | 0 | 0 | 1 | 1 | **2** |
| **Leipzig** | 1 | 1 | 8 | 8 | **18** |
| **Ludwigsburg** | 0 | 1 | 0 | 4 | **5** |
| **Luebeck** | 0 | 0 | 0 | 4 | **4** |
| **Mainz** | 0 | 3 | 0 | 7 | **10** |
| **Mannheim** | 0 | 2 | 2 | 2 | **6** |
| **Moers** | 0 | 0 | 0 | 1 | **1** |
| **Munich** | 13 | 28 | 4 | 78 | **123** |
| **Neuss** | 0 | 1 | 1 | 9 | **11** |
| **Nuremberg** | 7 | 10 | 4 | 11 | **32** |
| **Oberhausen** | 0 | 0 | 2 | 6 | **8** |
| **Offenbach** | 6 | 13 | 22 | 65 | **106** |
| **Osnabrueck** | 3 | 3 | 0 | 2 | **8** |
| **Paderborn** | 0 | 2 | 0 | 2 | **4** |
| **Pforzheim** | 0 | 0 | 1 | 2 | **3** |
| **Potsdam** | 11 | 12 | 31 | 58 | **112** |
| **Regensburg** | 0 | 2 | 0 | 2 | **4** |
| **Reutlingen** | 0 | 0 | 2 | 2 | **4** |
| **Saarbruecken** | 0 | 1 | 0 | 0 | **1** |
| **Siegen** | 1 | 0 | 0 | 0 | **1** |
| **Sindelfingen** | 0 | 1 | 0 | 2 | **3** |
| **Stuttgart** | 0 | 2 | 2 | 8 | **12** |
| **Trier** | 1 | 1 | 1 | 3 | **6** |
| **Troisdorf** | 0 | 2 | 0 | 0 | **2** |
| **Ulm** | 4 | 8 | 9 | 19 | **40** |
| **Wiesbaden** | 2 | 7 | 0 | 9 | **18** |
| **Worms** | 2 | 4 | 0 | 2 | **8** |
| **TOTAL GLOBAL** | **121** | **217** | **194** | **660** | **1192** |

> [!IMPORTANT]
> **Acțiuni imediate per contract:**
> - **Minijob (196 șoferi global)**: Aceștia trebuie concediați imediat sau convertiți în Werkstudent dacă îndeplinesc condițiile, fiindcă taxa de 52% face orice cursă pierzătoare.
> - **Teilzeit cu Mașină (433 șoferi global pe TZ, din care mulți auto)**: Aceștia reprezintă cea mai mare pierdere. Trebuie opriți din a utiliza mașina (trecuți pe bicicletă, decontare zero km) sau reduși.
> Acești șoferi vor fi înlocuiți de noul necesar de studenți sezonieri și Werkstudent descris în Secțiunea 3.2.
